...
public class ChamadoResource {
	...
	/**
	 * Retorna um Chamado a partir do id fornecido
	 *
	 * @param id
	 *
	 * @return ChamadoDTO
	...
	/**
	 * Possibilita a criação de um novo Chamado a partir das informações fornecidas no corpo da requisição
	 * e posteriormente retorna o Chamado criado.
	 *
	 * @param chamadoDTO
	 *
	 * @return ChamadoDTO
	...
	/**
	 * Possibilita a atualização de um Chamado a partir das informações fornecidas no corpo da requisição
	 * e posteriormente retorna o Chamado atualizado.
	 *
	 * @param id
	 * @param chamadoDTO
	 *
